...
train_vox_nonlinear(){
    ...
    --gpu_ids 0,1,2,3,4,5,6 --batchSize 49 --nThreads 64 --niter 1000 --niter_single 1001 \
    --n_shot 8 --n_frames_G 1 \
    --dataroot '/mnt/Data/lchen63/voxceleb' --dataset_name vox --save_epoch_freq 1 --display_freq 5000 \
