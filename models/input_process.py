...
def encode_input(opt, data_list, dummy_bs):
    ...
    tgt_label, tgt_image, tgt_crop_image, flow_gt, conf_gt, ref_label, ref_image, \
        warp_ref_lmark, warp_ref_img, ani_lmark, ani_img, prev_label, prev_real_image, prev_image = data_list
    ...
    return tgt_label, tgt_image, tgt_crop_image, flow_gt, conf_gt, ref_label, ref_image, warp_ref_lmark, \
        warp_ref_img, ani_lmark, ani_img, prev_label, prev_real_image, prev_image
