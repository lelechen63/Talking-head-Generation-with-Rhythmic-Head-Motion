...
class FewshotFaceVideoDataset(BaseDataset):
    @staticmethod
    ...
    def initialize(self, opt):
        ...
        if opt.isTrain:
            self.I_paths, self.L_paths = make_grouped_dataset_video(path.join(root, 'videos'), \
                                                                    path.join(root, 'landmarks_seq'), \
                                                                    opt.train_split, train=True)
